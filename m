...
Received: from isis.lip6.fr (isis.lip6.fr [132.227.60.2])
	by mail.lfdr.de (Postfix) with ESMTPS id 13FA4102E6C
	for <lists+cocci@lfdr.de>; Tue, 19 Nov 2019 22:44:25 +0100 (CET)
Received: from systeme.lip6.fr (systeme.lip6.fr [132.227.104.7])
	by isis.lip6.fr (8.15.2/8.15.2) with ESMTP id xAJLi87Q029838;
	Tue, 19 Nov 2019 22:44:11 +0100 (CET)
Received: from systeme.lip6.fr (systeme.lip6.fr [127.0.0.1])
	by systeme.lip6.fr (Postfix) with ESMTP id 753CE77D8;
	Tue, 19 Nov 2019 22:44:11 +0100 (CET)
...
Received: from isis.lip6.fr (isis.lip6.fr [132.227.60.2])
 ...
 by systeme.lip6.fr (Postfix) with ESMTPS id A95BA77DB
 for <cocci@systeme.lip6.fr>; Tue, 19 Nov 2019 22:44:07 +0100 (CET)
Received: from mail2-relais-roc.national.inria.fr
 (mail2-relais-roc.national.inria.fr [192.134.164.83])
 by isis.lip6.fr (8.15.2/8.15.2) with ESMTP id xAJLi6gJ022180
 for <cocci@systeme.lip6.fr>; Tue, 19 Nov 2019 22:44:06 +0100 (CET)
X-IronPort-AV: E=Sophos;i="5.69,219,1571695200"; d="scan'208";a="412575413"
...
Subject: [Cocci] [PATCH 2/4 v2] coccinelle: platform_get_irq: handle
